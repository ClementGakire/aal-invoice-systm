...
const UserProfile: React.FC = () => {
  ...
  const handleUpdateProfilePicture = async () => {
    ...
    try {
      ...
      setMessage({ type: 'error', text: 'An error occurred while updating your profile picture.' });
      setIsLoading(false);
    }
  };
  ...
  const removeProfilePicture = async () => {
    ...
    try {
      ...
      setMessage({ type: 'error', text: 'An error occurred while removing your profile picture.' });
    } finally {
      setIsLoading(false);
    }
  };
